...
Metoda 4, intoarce cartile comune dintre 2 retaileri. Utilizez Hashset pentru a face
complexitate O(n+m). Cu un for parcurg cartile de la primul retailer, le adaug in hashset.
Cu al 2 for parcurg al 2 array, verificand la fiecare iteratie daca cartea este si in
hashset si le adaug in array, care apoi il returnez.

Metoda 5, intoarce toate cartile a 2 retaileri, fara sa se repete. Cu 2 for-uri parcurg
array-urile si le pun in hashset. Apoi intr-n array sa le returnez. Hashset are proprietatea
de a contine elementele o singura data.
